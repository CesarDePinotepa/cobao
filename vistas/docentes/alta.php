...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Alta de docente</h1>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="../../control/docentes/guardar.php" method="post" class="form-horizontal" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text"  class="form-control" name="apaTxt"> </div>

                        </div>
                        <div class="form-group">
                            <label class="col-md-1">Apellido Materno</label>
                            <div class="col-md-5">
                                <input type="text"  class="form-control " name="amaTxt"> </div>

                        </div>
                        <div class="form-group">
                            <label class="col-md-1">RFC</label>
                            <div class="col-md-5">
                                <input type="text"  class="form-control " name="rfcTxt"> </div>

                        </div>
                        <div class="form-group">
                            <label class="col-md-1">CURP</label>
                            <div class="col-md-5">
                                <input type="text"  class="form-control " name="curpTxt"> </div>

                        </div>
                        <div class="form-group">
                            <label class="col-md-1">Dirección</label>
                            <div class="col-md-5">
                                <input type="text"  class="form-control " name="dirTxt"> </div>

                        </div>
                        <div class="form-group">
                            <label class="col-md-1">Teléfono</label>
                            <div class="col-md-5">
                                <input type="text"  class="form-control " name="telTxt"> </div>

                        </div>
                        <div class="form-group">
                            <label class="col-md-1">Email</label>
                            <div class="col-md-5">
                                <input type="email"  class="form-control " name="emaEma"> </div>

                        </div>
                        <div class="form-group">
                            <label class="col-md-1">Área</label>
                            <div class="col-md-5">
                                <input type="text"  class="form-control " name="areaTxt"> </div>
