...
<div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#" class="active"><i class="fa fa-repeat fa-fw"></i>Asignar materias</a>
                    </li><!--
                    <li>
    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Alta de estudiante</h1>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="../../control/estudiante/guardar-e.php" method="post" class="form-horizontal" >
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <input type="text"  class="form-control " name="escTxt"> </div>
