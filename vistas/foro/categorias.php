    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Alta de categorías</h1>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <form action="../../control/foro/guardar-ca.php" method="post" class="form-horizontal" >
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="table-responsive">
                                ...
                                <tbody>
                                <?php
                                    $consulta_m = "SELECT * FROM `foro_categoria`";
                                    ...
                                    while ($datos = $ejecutar2->fetch_assoc()) {
                                        ...
                                        echo "<td><a href='' onclick='return confirm(\"¿Inscribirse?\");' <i class='fa fa-edit fa-fw' aria-hidden='true'></i></a></td>";
                                        echo "<tr>";
                                    }
